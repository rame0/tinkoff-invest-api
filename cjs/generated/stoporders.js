...
exports.PostStopOrderRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.stopPrice !== undefined) {
            common_js_1.Quotation.encode(message.stopPrice, writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.stopPrice = common_js_1.Quotation.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    toJSON(message) {
        ...
        message.stopPrice !== undefined &&
            (obj.stopPrice = message.stopPrice
                ? common_js_1.Quotation.toJSON(message.stopPrice)
                : undefined);
...
exports.StopOrder = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.createDate !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.createDate), writer.uint32(58).fork()).ldelim();
        }
        if (message.activationDateTime !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.activationDateTime), writer.uint32(66).fork()).ldelim();
        }
        if (message.expirationTime !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.expirationTime), writer.uint32(74).fork()).ldelim();
        }
        if (message.price !== undefined) {
            common_js_1.MoneyValue.encode(message.price, writer.uint32(82).fork()).ldelim();
        }
        if (message.stopPrice !== undefined) {
            common_js_1.MoneyValue.encode(message.stopPrice, writer.uint32(90).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.createDate = fromTimestamp(timestamp_js_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 8:
                    message.activationDateTime = fromTimestamp(timestamp_js_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 9:
                    message.expirationTime = fromTimestamp(timestamp_js_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 10:
                    message.price = common_js_1.MoneyValue.decode(reader, reader.uint32());
                    break;
                case 11:
                    message.stopPrice = common_js_1.MoneyValue.decode(reader, reader.uint32());
                    break;
                case 12:
    ...
    fromJSON(object) {
        return {
            ...
            price: isSet(object.price)
                ...
                : undefined,
            stopPrice: isSet(object.stopPrice)
                ? common_js_1.MoneyValue.fromJSON(object.stopPrice)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.stopPrice !== undefined &&
            (obj.stopPrice = message.stopPrice
                ? common_js_1.MoneyValue.toJSON(message.stopPrice)
                : undefined);
