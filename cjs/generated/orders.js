    ...
    fromJSON(object) {
        return {
            orderTrades: isSet(object.orderTrades)
                ? exports.OrderTrades.fromJSON(object.orderTrades)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.orderTrades !== undefined &&
            (obj.orderTrades = message.orderTrades
                ? exports.OrderTrades.toJSON(message.orderTrades)
                : undefined);
    ...
    fromJSON(object) {
        return {
            ...
            trades: Array.isArray(object?.trades)
                ? object.trades.map((e) => exports.OrderTrade.fromJSON(e))
                : [],
    ...
    fromJSON(object) {
        return {
            ...
            initialOrderPrice: isSet(object.initialOrderPrice)
                ? common_js_1.MoneyValue.fromJSON(object.initialOrderPrice)
                : undefined,
            executedOrderPrice: isSet(object.executedOrderPrice)
                ? common_js_1.MoneyValue.fromJSON(object.executedOrderPrice)
                : undefined,
            ...
            initialCommission: isSet(object.initialCommission)
                ? common_js_1.MoneyValue.fromJSON(object.initialCommission)
                : undefined,
            executedCommission: isSet(object.executedCommission)
                ? common_js_1.MoneyValue.fromJSON(object.executedCommission)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.initialOrderPrice !== undefined &&
            (obj.initialOrderPrice = message.initialOrderPrice
                ? common_js_1.MoneyValue.toJSON(message.initialOrderPrice)
                : undefined);
        message.executedOrderPrice !== undefined &&
            (obj.executedOrderPrice = message.executedOrderPrice
                ? common_js_1.MoneyValue.toJSON(message.executedOrderPrice)
                : undefined);
        ...
        message.initialCommission !== undefined &&
            (obj.initialCommission = message.initialCommission
                ? common_js_1.MoneyValue.toJSON(message.initialCommission)
                : undefined);
        message.executedCommission !== undefined &&
            (obj.executedCommission = message.executedCommission
                ? common_js_1.MoneyValue.toJSON(message.executedCommission)
                : undefined);
        ...
        message.initialSecurityPrice !== undefined &&
            (obj.initialSecurityPrice = message.initialSecurityPrice
                ? common_js_1.MoneyValue.toJSON(message.initialSecurityPrice)
                : undefined);
        message.orderType !== undefined &&
            (obj.orderType = orderTypeToJSON(message.orderType));
        ...
        message.initialOrderPricePt !== undefined &&
            (obj.initialOrderPricePt = message.initialOrderPricePt
                ? common_js_1.Quotation.toJSON(message.initialOrderPricePt)
                : undefined);
        message.instrumentUid !== undefined &&
            (obj.instrumentUid = message.instrumentUid);
        return obj;
    ...
    fromJSON(object) {
        return {
            orders: Array.isArray(object?.orders)
                ? object.orders.map((e) => exports.OrderState.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            stages: Array.isArray(object?.stages)
                ? object.stages.map((e) => exports.OrderStage.fromJSON(e))
                : [],
            serviceCommission: isSet(object.serviceCommission)
                ? common_js_1.MoneyValue.fromJSON(object.serviceCommission)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.serviceCommission !== undefined &&
            (obj.serviceCommission = message.serviceCommission
                ? common_js_1.MoneyValue.toJSON(message.serviceCommission)
                : undefined);
