...
exports.MarketSubscription = void 0;
/**
...
class MarketSubscription {
    ...
    statusHandler({ subscriptions, subscriptionKeys, trackingId }) {
        ...
        const errorSubscriptions = subscriptions
            .filter(s => s.subscriptionStatus !== marketdata_js_1.SubscriptionStatus.SUBSCRIPTION_STATUS_SUCCESS);
...
exports.MarketSubscription = MarketSubscription;
