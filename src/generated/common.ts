...
export function resultSubscriptionStatusFromJSON(
  object: any
...
export function resultSubscriptionStatusToJSON(
  object: ResultSubscriptionStatus
): string {
  switch (object) {
...
export const Ping = {
  encode(message: Ping, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.pingRequestTime !== undefined) {
      Timestamp.encode(
        toTimestamp(message.pingRequestTime),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 4:
          message.pingRequestTime = fromTimestamp(
            Timestamp.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  toJSON(message: Ping): unknown {
    ...
    message.pingRequestTime !== undefined &&
...
export const BrandData = {
  ...
  fromJSON(object: any): BrandData {
    return {
      logoName: isSet(object.logoName) ? String(object.logoName) : "",
      logoBaseColor: isSet(object.logoBaseColor)
        ? String(object.logoBaseColor)
        : "",
  ...
  toJSON(message: BrandData): unknown {
    const obj: any = {};
    message.logoName !== undefined && (obj.logoName = message.logoName);
    message.logoBaseColor !== undefined &&
